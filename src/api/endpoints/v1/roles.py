...
from src.api.models.api.base import StringRepresent
from src.api.models.api.v1.role_pemission import (
    RequestRolePermissionShortCreate,
)
from src.api.models.api.v1.roles import (
    RequestRoleCreate,
    RequestRoleUpdate,
    ResponseRole,
...
from src.api.services.current_user import CurrentUserService, get_current_user
from src.api.services.role import RoleService, get_role_service
from src.api.services.role_pemission import (
    RolePermissionService,
    get_role_permission_service,
)
from src.api.validators.permission import (
    PermissionValidator,
    get_permission_validator,
    permission_uuid_annotation,
)
from src.api.validators.role import (
    RoleValidator,
    get_role_validator,
    role_uuid_annotation,
)
from src.api.validators.role_permission import (
